...
export const roles: Role[] = [
  ...
  { id: "movie-narrator", name: "影视解说", voiceName: "Charon", roleDescription: "影视剧解说，小帅风格，娓娓道来" },
  { id: "suspense", name: "悬疑解说", voiceName: "Charon", roleDescription: "低沉冷峻，悬念感强，适合惊悚悬疑题材" },
  { id: "friendly-aunt", name: "亲切客服", voiceName: "Kore", roleDescription: "热情亲切的大姐音，适合广告口播和客服" },
  { id: "ceo", name: "霸道总裁", voiceName: "Charon", roleDescription: "自信低沉，带有压迫感的精英男声" },
  { id: "gaming", name: "游戏解说", voiceName: "Puck", roleDescription: "语速偏快，充满激情与活力的游戏解说" },
